...
df_deathcost1 <- read.csv("data_climber_deathcost_mul1.csv") %>% mutate(group="DeathCost-1")
df_deathcost2 <- read.csv("data_deathcostminus10.csv") %>% mutate(group="DeathCost-2")
