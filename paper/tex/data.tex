...
\begin{thebibliography}{99}
   \bibitem[Oudeyer 2007]{IM}
   P. -Y. Oudeyer, F. Kaplan and V. V. Hafner,
   Intrinsic Motivation Systems for Autonomous Mental Development,
   IEEE Transactions on Evolutionary Computation, vol. 11, no. 2, pp. 265-286, April 2007.

   \bibitem[Burda 2019]{RND}
   Yuri Burda and Harrison Edwards and Amos Storkey and Oleg Klimov,
   Exploration by random network distillation,
   International Conference on Learning Representations,
   2019.
   
   \bibitem[Pecháč 2024]{SND}
